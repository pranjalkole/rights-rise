...
function App() {
  ...
  return (
    <>
      <header>
        <h1>RightsRise</h1>
        <a href="/updateProfile" className="updateProfile">
        ...
        <div className="half-width-container">
          <div className="flexbox half-width badges">
            ...
            <div className="flexbox">
              ...
              <img src="media/badges/active.png" alt="badges" className="badge" />
              <img src="media/badges/wizard.png" alt="badges" className="badge" />
              <img
